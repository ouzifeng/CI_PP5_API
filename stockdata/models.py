...
class General(models.Model):
    ...
    primary_ticker = models.CharField(max_length=100, null=True, blank=True)
...
class Technicals(models.Model):
    ...
    shares_short = models.IntegerField(null=True, blank=True)
    shares_short_prior_month = models.IntegerField(null=True, blank=True)
...
class BalanceSheet(models.Model):
    ...
    def __str__(self):
        return (
            f"{self.type.title()} Balance Sheet for {self.general.name} "
            f"({self.date})"
        )
...
class CashFlow(models.Model):
    ...
    def __str__(self):
        return (
            f"{self.type.title()} Cash Flow for {self.general.name} "
            f"({self.date})"
        )
...
class IncomeStatement(models.Model):
    ...
    def __str__(self):
        return (
            f"{self.type.title()} Income Statement for {self.general.name} "
            f"({self.date})"
        )
...
class CAGR(models.Model):
    ...
    total_revenue_cagr = models.DecimalField(
        max_digits=10, decimal_places=4, null=True, blank=True
    )
    gross_profit_cagr = models.DecimalField(
        max_digits=10, decimal_places=4, null=True, blank=True
    )
    net_income_cagr = models.DecimalField(
        max_digits=10, decimal_places=4, null=True, blank=True
    )
...
class StockPrices(models.Model):
    ...
    Y3 = models.DecimalField(
        max_digits=15, decimal_places=2, null=True, blank=True,
        validators=[MinValueValidator(Decimal('0.01'))]
    )
    Y4 = models.DecimalField(
        max_digits=15, decimal_places=2, null=True, blank=True,
        validators=[MinValueValidator(Decimal('0.01'))]
    )
    Y5 = models.DecimalField(
        max_digits=15, decimal_places=2, null=True, blank=True,
        validators=[MinValueValidator(Decimal('0.01'))]
    )
    Y6 = models.DecimalField(
        max_digits=15, decimal_places=2, null=True, blank=True,
        validators=[MinValueValidator(Decimal('0.01'))]
    )
    cagr_5_years = models.DecimalField(
        max_digits=10, decimal_places=4, null=True, blank=True
    )
...
class DividendYieldData(models.Model):
    ...
    yield_Y1 = models.DecimalField(
        max_digits=6, decimal_places=4, null=True, blank=True
    )
    yield_Y2 = models.DecimalField(
        max_digits=6, decimal_places=4, null=True, blank=True
    )
    yield_Y3 = models.DecimalField(
        max_digits=6, decimal_places=4, null=True, blank=True
    )
    yield_Y4 = models.DecimalField(
        max_digits=6, decimal_places=4, null=True, blank=True
    )
    yield_Y5 = models.DecimalField(
        max_digits=6, decimal_places=4, null=True, blank=True
    )
    cagr_5_years = models.DecimalField(
        max_digits=6, decimal_places=4, null=True, blank=True
