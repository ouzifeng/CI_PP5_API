...
def import_tickers(api_token, exchange='KLSE'):
    ...
    if response.status_code == 200:
        ...
        for entry in ticker_data:
            ...
            if len(uid) > 20:
                print(f"Skipping ticker {uid} because it's longer than 20 characters.")
                continue
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        stocks = General.objects.filter(uid__endswith='KLSE')
